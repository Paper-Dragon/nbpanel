...
//基本设置--------------------------------------------------------------------------------------------
$_ENV['key'] = '1145141459810';						//!!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$_ENV['debug'] =  false;								//正式环境请确保为 false
$_ENV['appName'] = '音速科技';							//站点名称
$_ENV['baseUrl'] = 'https://ilaosiji.xyz';					//站点地址
$_ENV['subUrl'] = $_ENV['baseUrl'] . '/link/';	//订阅地址，如需和站点名称相同，请不要修改
$_ENV['muKey'] = 'MuPassw0rdKey';								//用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
...
# smtp
$_ENV['smtp_host'] = 'smtpout.secureserver.net';
$_ENV['smtp_username'] = 'non-reply@ilaosiji.xyz';
$_ENV['smtp_port'] = 587;
$_ENV['smtp_name'] = '音速科技';
$_ENV['smtp_sender'] = 'non-reply@ilaosiji.xyz';
$_ENV['smtp_passsword'] = '4O0KbYquEf3w';
$_ENV['smtp_ssl'] = false;
...
//已注册用户设置---------------------------------------------------------------------------------------
#基础
$_ENV['checkinMin'] = 100;			//用户签到最少流量 单位MB
...
$_ENV['invite_gift'] = 5;			//邀请新用户获得流量奖励，单位G
...
$_ENV['telegram_token']             = '1713851146:AAEIfmKB6IoXTuI6ZnijMZMx67p6UBOjc84';           //Telegram Bot 的 Token，跟 Father Bot 申请
$_ENV['telegram_bot']               = 'ilaosiji_bot';           //Telegram Bot 用户名
$_ENV['telegram_group_quiet']       = false;        //Telegram Bot 在群组中不回应
$_ENV['telegram_chatid']            = '-1001294031879';           //Telegram 群组会话 ID，把 Bot 拉进群里之后跟他 /ping 一下即可得到。
$_ENV['telegram_request_token']     = 'Key';           //Telegram 机器人请求验证 Key，随意设置，由大小写英文和数字组成，更新这个参数之后请 php xcat setTelegram
...
$_ENV['telegram_group_link']        = 'https://t.me/ilaosiji';           //用户群的链接
...
$_ENV['help_any_command']           = true;        //允许任意未知的命令触发 /help 的回复
...
$_ENV['detect_gfw_interval'] = 0;										//检测间隔，单位：秒，低于推荐值会爆炸
$_ENV['detect_gfw_port'] = 22;												//所有节点服务器都打开的TCP端口，常用的为22（SSH端口）
$_ENV['detect_gfw_url'] = 'http://torch.biu.best/{ip}/{port}';				//检测节点是否被gfw墙了的API的URL
...
$_ENV['cacheDriver'] = 'redis';			//可选: cookie,redis
$_ENV['tokenDriver'] = 'redis';				//可选: db,redis
