...
$Malio_Config['google_analytics_code'] = 'UA-195354918-1';    // Google 统计代码，留空为不开启，code格式为 'UA-123456789-1'
...
$Malio_Config['small_brand'] = '速';    // 侧边栏在缩小状态下显示的 logo 名称，建议写两个英文字母或一个中文汉字
...
$Malio_Config['enable_i18n'] = false;   //  是否显示切换语言的按钮
$Malio_Config['default_lang'] = 'zh-cn';   //  面板默认的语言，支持 en | zh-cn
$Malio_Config['only_one_lang'] = 'zh-cn';   //  强制使用某种语言，支持 en | zh-cn | none
...
$Malio_Config['register_email_white_list'] = ['@qq.com','@gmail.com','@outlook.com','@163.com','@126.com','@yeah.net','@foxmail.com'];   // 注册时的邮箱后缀白白白白白白名单，仅在上面的设置为true时生效
...
####### 订阅设置 #######
$Malio_Config['support_sub_type'] = ['v2ray'];    // 选择网站支持的代理协议，会影响复制订阅链接和一键导入按钮的显示。比如删除这个参数里的ss，则 Surge 订阅按钮不会显示再首页上，教程里也不会显示Surge教程
...
$Malio_Config['enable_sub_extend'] = true;   //  设置为true时，订阅将包含等级过期时间和流量信息
...
$Malio_Config['enable_share_account_page'] = false;  // 是否在侧边栏显示共享账号页面 (定制功能)
$Malio_Config['enable_sidebar_button'] = true;    // 是否显示底部 Telegram 按钮
$Malio_Config['telegram_group'] = 'https://t.me/ilaosiji';   // Telegram 按钮的链接
...
$Malio_Config['enable_share'] = false;   // 是否显示共享账号
...
$Malio_Config['enable_delete'] = false;   // 是否显示删除账号的选项
...
$Malio_Config['taiwan_flag'] = 'tw';   //  台湾的旗显示方式，cn为中国国旗，tw为台湾区旗
...
####### 下载和使用 #######
$Malio_Config['display_more_app_button'] = false;   // 教程页面是否显示”其他客户端按钮“
...
$Malio_Config['index_enable_promotion'] = false;   // 着陆页是否显示促销活动提示
